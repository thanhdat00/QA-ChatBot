...
class HanSuDungDatSpider(scrapy.Spider):
    name = "han_su_dung_dat"

    def __init__(self, *args, **kwargs):
        super(HanSuDungDatSpider, self).__init__(*args, **kwargs)
        self.utils = Utils()
    ...
    def start_requests(self):
        dir = '/home/datltt/Documents/luat-dat-dai/thoi-han-su-dung-dat/'
    ...
    def spider_closed(self, spider):
        encoding: str = "utf-8"
        path = '/home/datltt/Documents/luat-dat-dai/output/thoi-han-su-dung-dat-ouput.jsonl'
        invalid_link_path = '/home/datltt/Documents/output/luat-dat-dai/thoi-han-su-dung-dat-invalid.jsonl'
